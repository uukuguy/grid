...
- **L4 observability log records = 0** — demo 第 9 步报 L4 侧 `l4.*` 指标日志 0 条。L1 侧 6/6 已验证,**L2/L3/L4 侧的 record 是否真被调用尚未逐层实测**;按本次教训(定义 ≠ 调用),v3.16 值得照 L1 的方式各查一遍。
